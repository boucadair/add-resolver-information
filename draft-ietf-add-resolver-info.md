...
#  Resolver Information Keys/Values {#key-val}
   ...
   : It contains the signature of the RESINFO RR excluding the "sig"	
	   attribute.  The signature is generated by the encrypted DNS resolver	
		...
		public key in the DNS resolver's end-entity certificate.  As a	
...
#  Security Considerations
   ...
   If a resolver supports DDR but does not support RESINFO, the client	
	...
	MUST convey the "sig" attribute. In addition to the validaton checks in {{Section 4.2 of I-D.ietf-add-ddr}},  DNS clients using DDR for encrypted	
